...
Original file is located at
    https://colab.research.google.com/drive/1ojfq7fsgn22aG0k-YnGFimRvYD1mkZv_
"""
...
class ResidualBlock(torch.nn.Module):
  ...
  def forward(self,s_feats, q_points, s_points, neighbor_indices):
    s_feats = self.unary1(s_feats)

    x = self.conv(s_feats, q_points, s_points, neighbor_indices)
